...
public final class ActivityQrScanBinding implements ViewBinding {
  ...
  private ActivityQrScanBinding(@NonNull RelativeLayout rootView, @NonNull ImageButton btnBack,
      @NonNull TextView tvInstructions, @NonNull TextView tvStatus,
  ...
  public static ActivityQrScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityQrScanBinding((RelativeLayout) rootView, btnBack, tvInstructions, tvStatus,
          viewFinder);
    }
